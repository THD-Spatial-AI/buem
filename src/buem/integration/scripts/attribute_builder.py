...
# occupancy is an optional independent package (https://github.com/enerplanet/occupancy, fork of UU-BUEM/occupancy),
# not published to PyPI. Install with:
# pip install git+https://github.com/enerplanet/occupancy.git@fix/config-path-resolution
try:
